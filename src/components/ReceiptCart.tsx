    ...
    <section className="max-w-5xl mx-auto px-4 py-12">
      <div className="max-w-md mx-auto">
        <div className="receipt-border bg-[#fafaf7] p-6 font-mono">
          ...
          <div className="dashed-divider" />
          <div className="flex justify-between text-xs mb-1"><span>SUBTOTAL:</span><span>$24.99</span></div>
          <div className="flex justify-between text-xs mb-1"><span>TAX (8%):</span><span>$2.00</span></div>
          <div className="flex justify-between text-xs mb-1"><span>SHIPPING:</span><span>FREE</span></div>
          <div className="dashed-divider" />
          <div className="flex justify-between font-bold text-base mb-4"><span>TOTAL:</span><span>$26.99</span></div>
          <div className="flex justify-center mb-4"><Barcode /></div>
          <div className="dashed-divider" />
